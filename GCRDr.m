...
% - tol is an absolute tolerance used in the rank decisions
%       therefore P must have Frobenius norm 1 : norm(P(:))=1
%
...
% trim the zero leading coefficients
N=Trim(N,tol);
